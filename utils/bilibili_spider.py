...
class Bilibili_Spider():
    ...
    def __init__(self, uid, save_dir_json='json', save_by_page=False, t=2, filter_cfg=None):
    ...
    def save(self, json_path, bvs, urls, titles, plays, durations, dates, title_filter):
        data_list = []
    ...
    def get(self):
        ...
        self.save(json_path, bvs, urls, titles, plays, durations, dates, self.filter_cfg['title'])
