...
def main(args):
    filter_cfg = {'title': '南京航空航天大学'}
    bilibili_spider = Bilibili_Spider(args.uid, args.save_dir, args.save_by_page, args.time, filter_cfg)
    bilibili_spider.get()
    if args.detailed:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--uid', type=str, default='20554233')
